...
params = {
    tree: [t1],
    num_threads: [64,128,256],#[16, 32, 64, 72, 78, 84, 96, 100, 101, 102, 103, 104, 108, 118, 128, 256, 512],
    chunk_size: [1,10,20],#[1, 2, 3, 4, 5, 6, 8, 10, 16, 20, 50],
    poll_interval: [1],
    num_places: [1],
    num_procs: [2],
    trial: [1,2,3],
    doSteal: [0,1],
    distributeInitial: expr('1-doSteal')
}
