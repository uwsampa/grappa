...
unit) 2.1-GHz processors, and 64GB of memory, and \TODO{xxx 40Gb network card}. \todo{cluster
...
For the MTA comparison, we use a 128-node Cray XMT (3rd generation
...
\paragraph{Unbalanced tree search in-memory (UTS-Mem)}, is a benchmark
...
that touch existing data. We augment UTS by using the traversal to
