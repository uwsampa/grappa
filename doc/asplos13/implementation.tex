...
worker \TODO{reorder this paragraph after defined} ID and space for a response, issue their request active
...
have only one outstanding delegate operation \TODO{this is not an
    inherent limitation, it would be better to discuss in terms of
    fence -BM}. We limit delegate
...
\paragraph{Caches} Cache operations are used to exploit spatial or temporal
