...
\lstset{
  emph={GlobalAddress,Grappa,GlobalStack,ConditionVariable,Mutex,T,GlobalStackProxy,FCProxy}, emphstyle={\color{NavyBlue}\bfseries},
  emph={[2]delegate, write, acquire, release, core, call, signal, push, pop, sync, block, memcpy}, emphstyle={[2]\color{PineGreen}\bfseries}
}
