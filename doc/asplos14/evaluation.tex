...
parallel slack \comment{\TODO{cite Valiant and say more somewhere about BSP}}), while T3 trees are very deep (i.e., little parallel slack).
...
\begin{figure}[ht]
    ...
    \end{center}
    \caption{Vertices per second in UTS on \Grappa as the number of nodes grows. \TODO{modify discussion inline to match new plot}}
...
of common sizes. Future work will reduce this cost.  \comment{Ack! -Mark}
