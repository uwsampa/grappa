...
\begin{figure}[ht]
    \begin{center}
      \includegraphics[height=0.5\textwidth]{results/plot_concurrency.pdf}
    \end{center}
...
\begin{figure}[ht]
    \begin{center}
      \includegraphics[height=0.5\textwidth]{results/plot_scaling.pdf}
    \end{center}
    \caption{Scaling for BFS, IntSort, and Pagerank. Refer to Figure~\cite{fig:grappa-gups} for GUPS scaling and Figure~\cite{fig:grappa-uts} for UTS scaling}
    \label{fig:grappa-scaling}
\end{figure}

Figures~\cite{fig:grappa-scaling}, \cite{fig:grappa-gups}, and
\cite{fig:grappa-uts} show scaling out to 64 nodes. Grappa scales best
