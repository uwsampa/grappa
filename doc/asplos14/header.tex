...
\lstset{
  ...
  emph={[2]delegate, write, acquire, release, core, call, signal, push, pop, sync, block, memcpy, parallel_for, delegate_read, delegate_write, search}, emphstyle={[2]\color{PineGreen}}
}
