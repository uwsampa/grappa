...
A natural first step would be to add one or more \textls*{\small SSD}\hspace{0.75pt}s to each Grappa
...
generate 100 million random 8-byte requests per second, but most \textls*{\small SSD}\hspace{0.75pt}s
...
100 million per second, the \textls*{\small SSD}\hspace{0.75pt}s must support 2000 concurrent
