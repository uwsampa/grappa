...
alternative.  We imagine placing the entire data set on \textls*{\small SSD} or \textls*{\small PCM} and
...
of data into \textls*{\small RAM}, using Grappa to tolerate the latency incurred by the
