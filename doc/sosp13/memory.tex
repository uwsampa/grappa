...
\TODO{If we do want a section on GlobalCompletionEvent:
  \begin{itemize}
    ...
    \item GlobalCompletionEvent is complicated by task-stealing and the fact that delegate operations complete on a different core than they started, forcing us to use a ``cancelable barrier''-like approach
