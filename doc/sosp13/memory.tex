...
% We restrict the use of delegate operations in order to make them also
% useful for synchronization operations.
...
% \TODO{Not sure this warrants its own paragraph, seems like the explicit caches are just the same as reading and then writing using delegates.}
