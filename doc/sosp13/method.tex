...
vector. We compare PageRank to published results for the Tilinos linear algebra library implemented in MPI, and multithreaded PageRank for the XMT \cite{MTGL:pagerank}.
