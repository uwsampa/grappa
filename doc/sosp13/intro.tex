...
\noindent{\bf Irregular applications exhibit little data locality.} Data
...
\noindent{\bf Irregular applications frequently request small amounts of
off-node data.} On multi-node systems, the challenges presented by low
