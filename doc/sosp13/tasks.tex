...
%% Note sure this is even true.  And it's confusing and not relevant regardless. -M
% There are two types of workers: (1) user worker; and (2) system worker. 
%System workers execute runtime management activities such as communication and statistics collection. User workers and system workers might have different scheduling priorities. System workers execute periodically and in idle times, to guarantee timely communication services.
...
\noindent {\it ready worker queue}, a FIFO queue of workers that are
