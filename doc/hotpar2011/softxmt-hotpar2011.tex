...
{\small XMT} is an expensive, non-commodity machine.
...
can attain {\small XMT}-like performance with a familiar, {\small XMT}-like,
...
on 1~GB huge pages to minimize TLB refill overhead.
...
We varied the size of the per-coroutine local working set from 2~KB
