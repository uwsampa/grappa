...
to have trillions of entities~\cite{hartley:mssg, kolda:imkd}. Speeding
...
imbalance. High-latency inter-node communication is a limiting factor
in scalability~\cite{yoo:parallelbfs}.
