...
we access the other chip's memory and also have the scheduler of our coroutine library include a delay
before a coroutine can be rescheduled, imitating the network transit
delay even though we are referencing local memory. We assume 1.1 $\mu$s interface and 400 ns switch latencies in each direction
