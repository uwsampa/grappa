...
\authorinfo{Jacob Nelson$^{\dagger}$, Brandon Myers$^{\dagger}$, A.H. Hunter$^{\dagger}$, Preston Briggs$^{\dagger}$,
  Dan Grossman$^{\dagger}$, Mark Oskin$^{\dagger}$, Carl Ebeling$^{\dagger}$, Simon Kahan$^{{\dagger \ddagger}}$, Luis
  Ceze$^{\dagger}$}{\textdagger University of Washington, \textdaggerdbl Pacific Northwest National Laboratory}{\{nelson, bdmyers, ahh, preston,
...
\subsection{Base memory system performance}
