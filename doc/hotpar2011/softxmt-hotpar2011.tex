...
\begin{abstract}
  ...
  demands new techniques; especially in the parallel case,
  straightforward algorithms will run inefficiently due to many
  high-latency accesses.  Pervasive parallelism can tolerate that
  latency, but the only large-scale implementation of the technique is
  the Cray XMT, an expensive, non-commodity machine.
