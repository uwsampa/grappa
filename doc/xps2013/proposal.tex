...
by extra hops in hierarchical aggregation turns out to be a big factor, we
will explore reducing by move some of the aggregation logic to the network
...
which at last two of the PIs serve as advisors. In addition to the project
described in this proposal, they are also working together on techniques for
...
Kahan has tremendous experience in ... from Tera/Cray ... {\bf SIMON PUT YOUR STUFF HERE.}
