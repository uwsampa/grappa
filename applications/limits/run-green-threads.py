...
#cmd = "hugectl --heap -- numactl --membind=0 -- ./linked_list.exe 24 %d %d %d"

##cmd = "numactl --membind=0 -- ./linked_list.exe 24 %d %d %d"
cmd = "numactl --membind=0 -- ./seq.exe 24 %d %d %d"
...
for num_threads in range(1, max_threads+1):
	...
	for green_threads_per in green_list:
		...
		# write just these results in case of crash we save work
		#f = open('multi-green2/S_24_%d_%d_%d.csv'%(green_threads_per,num_threads,concurrent_reads), 'w')
