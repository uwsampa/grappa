...
static void run_isopaths(tuple_graph *tg, csr_graph *g) {
...
static void populate_graph(tuple_graph *tg, csr_graph *g) {
  TIME(construction_time, create_graph_from_edgelist(tg, g));
}
