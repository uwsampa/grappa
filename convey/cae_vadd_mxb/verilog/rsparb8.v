...
//-----------------------------------------------------------------------------
//
// Description     : MC response 8-way round robin arbiter with advance control
//
...
//
/*****************************************************************************/
/* $Id: rsparb8.vpp,v 1.1.1.1 2010/09/14 20:23:30 gedwards Exp $ */

module rsparb8 (/*AUTOARG*/
   // Outputs
   o_grant0, o_grant1, o_grant2, o_grant3, o_grant4, o_grant5,
   o_grant6, o_grant7, o_gsel, o_push,
   // Inputs
   ...
   // synthesis attribute keep_hierarchy rsparb8 "true";
   ...
   assign o_push = r_push;

   // Next grant per current grant and requests.
   always @* begin
     c_gsel = r_gsel;
     c_lastreq = i_lastreq0;
     case (r_gsel)
     3'd0: begin
       casex ({c_gcmax, i_empty1, i_empty2, i_empty3, i_empty4,
     ...
     3'd1: begin
       casex ({c_gcmax, i_empty2, i_empty3, i_empty4, i_empty5,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq1;
     end
     3'd2: begin
       casex ({c_gcmax, i_empty3, i_empty4, i_empty5, i_empty6,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq2;
     end
     3'd3: begin
       casex ({c_gcmax, i_empty4, i_empty5, i_empty6, i_empty7,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq3;
     end
     3'd4: begin
       casex ({c_gcmax, i_empty5, i_empty6, i_empty7, i_empty0,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq4;
     end
     3'd5: begin
       casex ({c_gcmax, i_empty6, i_empty7, i_empty0, i_empty1,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq5;
     end
     3'd6: begin
       casex ({c_gcmax, i_empty7, i_empty0, i_empty1, i_empty2,
       ...
       default:       c_gsel = r_gsel;
       endcase
       c_lastreq = i_lastreq6;
     end
     3'd7: begin
       casex ({c_gcmax, i_empty0, i_empty1, i_empty2, i_empty3,
   ...
   assign c_gcmax = c_lastreq | (r_gcnt == 3'b110);
   ...
   assign c_grant0 = (c_gsel == 3'd0) & ~i_stall;
   assign c_grant1 = (c_gsel == 3'd1) & ~i_stall;
   assign c_grant2 = (c_gsel == 3'd2) & ~i_stall;
   assign c_grant3 = (c_gsel == 3'd3) & ~i_stall;
   assign c_grant4 = (c_gsel == 3'd4) & ~i_stall;
   assign c_grant5 = (c_gsel == 3'd5) & ~i_stall;
   assign c_grant6 = (c_gsel == 3'd6) & ~i_stall;
   assign c_grant7 = (c_gsel == 3'd7) & ~i_stall;
   ...
   dff_1 reg_push ( .clk(clk), .d(c_push), .q(r_push) );
